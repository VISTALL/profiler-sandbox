...
public class ThreadProfiler {
    ...
    private static void serialize(DataOutputStream out, MethodGroup[] methods)
        throws IOException {
        out.writeInt(SnapshotConstants.SNAPSHOT_MAGIC);
        out.writeInt(SnapshotConstants.SNAPSHOT_PROTOCOL_VERSION);
        out.writeInt(SnapshotConstants.SNAPSHOT_TYPE_CALLTRACE);
