        ...
        while (true) {
            ...
            switch (in.readInt()) {
                ...
                case CMD_APPLY_RULES :
                    ...
                    // Send the number of classes the will be reloaded to the client
                    out.writeInt(n);
                    out.flush();
                    while (progress[0] < n) {
                        try {
                        ...
                        // Send the current number of reloaded classes to the client
                ...
                case CMD_LIST_CLASSES :
					...
					for (int i = 0; i < classes.length; i++) {
						...
						out.writeBoolean(BytecodeTransformer.list.contains(classes[i].getName()));
					}
                    out.flush();
                    break;
                ...
                case CMD_GET_THREAD_INFO :
                    ...
                    out.writeUnshared(ServerUtil.makeSerializable(Agent.threadbean
